...
import { ExecutionLog } from "@/prisma/@/lib/prisma";
    ...
    <div className="flex w-full h-full">
      ...
      <div className="flex w-full h-full">
        ...
        {!isRunning && selectedPhase && phaseDetails.data && (
          <div className="flex w-full flex-col py-4 container px-2 gap-4 overflow-auto">
  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="p-0">
        <Table>
          <TableHeader className="h-fit w-full">
          ...
          <TableBody>
            {logs.map((log) => (
              <TableRow
                key={log.id}
                className="text-muted-foreground h-20 text-start"
              >
                <TableCell
                  width={190}
                ...
                <TableCell className="text-sm w-full flex-1 p-[3px] pl-4 whitespace-pre-wrap break-words">
                  {log.message}
                </TableCell>
              </TableRow>
            ))}
